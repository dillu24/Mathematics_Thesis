...
\begin{definition}
\label{TSP}
Given a complete weighted graph G, the Travelling Salesman Problem (TSP) is the task of finding a minimum weight Hamiltonian cycle in G. {\normalfont{\cite{bondy_murty_1982}}}
\end{definition}
