...
%give book suggested params, for beta etc.. also book has explanation of everything for these parameters so use them. wasalt fejn tibda tiddiskrivi l formula
\begin{equation}
  \label{eq:aco1}
  s=\begin{cases}
